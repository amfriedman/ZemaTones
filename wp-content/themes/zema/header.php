...
<script type="text/javascript" src="<?php echo get_bloginfo('template_url'); ?>/../../plugins/wpaudio-mp3-player/sm2/soundmanager2.js"></script>

<script type="text/javascript">
//Firebug.framePosition="top";

soundManager.url = "<?php echo get_bloginfo('template_url'); ?>/../../plugins/wpaudio-mp3-player/sm2/";
soundManager.onready(function(){
  ...
  var mySound = soundManager.createSound({
    id: 'aSound',
    url: 'http://zematones.com/wp-content/uploads/woocommerce_uploads/2012/01/claps.wav',
	
	//'http://zematones.com/wp-content/uploads/woocommerce_uploads/2012/01/mak.mp3',
