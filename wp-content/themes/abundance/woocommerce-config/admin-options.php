...
function avia_woocommerce_set_defaults()
{
	global $avia_config;
	//catalog
	update_option('woocommerce_catalog_image_width', $avia_config['imgSize']['shop_catalog']['width']);
	update_option('woocommerce_catalog_image_height',$avia_config['imgSize']['shop_catalog']['height']);
	update_option('woocommerce_catalog_image_crop','1');

	//thumbnail
	update_option('woocommerce_single_image_width', $avia_config['imgSize']['shop_single']['width']);
	update_option('woocommerce_single_image_height',$avia_config['imgSize']['shop_single']['height']);
	update_option('woocommerce_single_image_crop','1');
	
	//single
	update_option('woocommerce_thumbnail_image_width', $avia_config['imgSize']['shop_thumbnail']['width']);
	update_option('woocommerce_thumbnail_image_height',$avia_config['imgSize']['shop_thumbnail']['height']);
